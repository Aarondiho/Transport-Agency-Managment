<?php  
     ...
     $user_query = $conn->query("SELECT * FROM users ORDER BY idUser DESC"); 
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl blur shadow-blur mt-4 left-auto top-1  " >
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Listes des Utilisateurs</h6>
        </nav>
            ...
            <div class="card-header pb-0 p-3">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="index.php?page=userAdd"><i class="material-icons text-xl">add_circle</i>&nbsp;&nbsp;Utilisateur</a>
                    </div>
                </div>
            </div>
            <br>
                ...
                <table id="example" class="table table-striped align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php if($row['type']==2){ echo 'Charoi';}else if($row['type']==1){ echo 'Comptable';}else{ echo 'Administrateur';} ?></p>
                        <p class="text-xs text-secondary mb-0">Organization</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                         <a href="index.php?page=users&idInit=<?php echo $id; ?>" 
                        ...
                        <span class="badge badge-sm bg-gradient-success">Réinitialiser</span>
                        </a>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <a href="index.php?page=users&idActive=<?php echo $id; ?>&status=<?php echo $row['status']; ?>" 
                      ...
                      <td class="align-middle text-center text-sm">
                        <a href="index.php?page=userAdd&id=<?php echo $id ; ?>" class="text-secondary font-weight-bold text-xl" data-toggle="tooltip" data-original-title="Edit sport">
                      ...
                      <td class="align-middle text-center text-sm">
                         <a href="index.php?page=users&supp=<?php echo $id; ?>" onclick="return confirm('Voulez-vous vraiment supprimer?')" class="text-secondary font-weight-bold text-xl" data-toggle="tooltip" data-original-title="Edit club">
...
if(isset($_GET["supp"])){
  ...
  $delete=$conn->EXEC("DELETE FROM users WHERE idUser = $idtodelete");
  if($delete){
    ?>
    <script>
            swal({
...
$id = $_GET['idActive'];
  ...
  $save = $conn->EXEC("UPDATE users SET status ='$stat' WHERE idUser='$id'");

    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          ...
          <h6 class="font-weight-bolder mb-0">Dépots & Bordéreaux</h6>
        </nav>
            ...
            <div class="card-body px-0 pb-2">
              <div class=" p-0">
                <table id="example" class="table table-striped align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-xl font-weight-bold ">Bordéreaux</th>
                    ...
                    <tr>
                      <td>
                        ...
                        <a class="d-block shadow-xl border-radius-xl" href="../photos/<?php  echo $row['cheque']; ?>" target="_blank">
                            <img src="../photos/<?php echo $row['cheque']; ?>" class="avatar avatar-xl me-3 border-radius-lg" alt="cost1">
                          </a>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo str_replace(',','.',number_format($row['amount'])); ?> F</p>
                      </td>
                      ...
                      <td>
                        <h6 class="text-xs font-weight-bold mb-0 text-center"><?php echo date('d-m-Y', strtotime($row['dateDeposit'])); ?></h6>
                      </td>

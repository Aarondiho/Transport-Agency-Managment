      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Rapport </li>
          </ol>
    ...
    <div class="card-header pb-0 p-3">
        <div class="row">
            ...
            <div class="col-4 text-end">
              <a href="reportPDF.php?initialDate=<?php echo $initialDate;?>&finalDate=<?php echo $finalDate;?>">
                    <button  class="btn btn-success" style="margin-top:5px">PDF</button>
              </a>
              <a href="excel.php?page=rapport&initialDate=<?php echo $initialDate;?>&finalDate=<?php echo $finalDate;?>">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo str_replace(',','.', number_format($pay['vers']?$pay['vers']:0)); ?> F</h4>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo str_replace(',','.', number_format($depense['dep']?$depense['dep']:0)); ?> F</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo str_replace(',','.', number_format(($pay['vers']?$pay['vers']:0) - ($depense['dep']?$depense['dep']:0))); ?> F</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo str_replace(',','.', number_format($depot['depot']?$depot['depot']:0)); ?> F</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
          ...
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              ...
              <div class="d-flex ">
                ...
                <p class="mb-0 text-sm"> Derniers 6 mois </p>
              </div>
            </div>
          </div>
        </div>

    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl blur shadow-blur mt-4 left-auto top-1  " >
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Listes des Versements</h6>
        </nav>
                ...
                <div class="row">
                    <div class="col-8">
                          ...
                          <span class="text-info">
                            <i class="fa fa-calendar text-"></i> Choisir Date
                          </span>
                          ...
                          <a class="btn bg-gradient-dark mb-0" href="index.php?page=paymentAdd"><i class="material-icons text-xl">add_circle</i>Versement</a>
                    ...
                    <div class="col-4 text-end">
                      <a href="payPDF.php?initialDate=<?php echo $initialDate;?>&finalDate=<?php echo $finalDate;?>">
                            <button  class="btn btn-success" style="margin-top:5px">PDF</button>
                      </a>
                      <a href="excel.php?page=pay&initialDate=<?php echo $initialDate;?>&finalDate=<?php echo $finalDate;?>">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <h6 class=" w-10 text-xl font-weight-bold mb-0"><?php echo $i ; ?></h6><img src="../photos/<?php echo $row['cheque']; ?>" class="avatar avatar-xs me-3 border-radius-lg" alt="cost1">
                          </a>
                      ...
                      <td class="align-middle text-center text-sm">
                        <a href="index.php?page=paymentAdd&id=<?php echo $id ; ?>" class="font-weight-bold text-xl" data-toggle="tooltip" data-original-title="Edit sport">
                      ...
                      <td class="align-middle text-center text-sm">
                         <a href="index.php?page=payments&supp=<?php echo $id; ?>" onclick="return confirm('Voulez-vous vraiment supprimer?')" class="font-weight-bold text-xl" data-toggle="tooltip" data-original-title="Edit club">
...
if(isset($_GET["supp"])){
  ...
  $delete=$conn->EXEC("DELETE FROM payments WHERE idPay = $idtodelete");
  if($delete){
    ?>
    <script>
            swal({
...
function (start, end) {
  ...
  var captureRange = $("#daterange-btn2 span").html();
   ...
   window.location = "index.php?page=payments&initialDate="+initialDate+"&finalDate="+finalDate;

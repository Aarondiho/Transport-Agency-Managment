...
<div class="main-content position-relative max-height-vh-100 h-100">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Changer Mot de Passe</li>
          </ol>
          <h6 class="font-weight-bolder mb-0"><?php if(isset($_GET['id'])){ echo 'Editer un Utilisateur' ;}else{ echo 'Changez Votre Mot de Passe' ;} ?></h6>
        </nav>
    ...
    <div class="container-fluid px-2 px-md-4">
      ...
      <div class="card card-body mx-4 mx-md-4 mt-n10">
        ...
        <div class="card-body">
                <form role="form" class="text-start" id="change_password" enctype="multipart/form-data">
                ...
                <input type="hidden" id="password" name="id" value="<?php echo $session_id ; ?>" required>
                  ...
                  <div class="input-group input-group-outline my-1">
                        <input type="password" class="form-control"  name="password"  id="passwordo"  required>
                  </div>

                    <label class="form-label">Répeter le Mot De Passe</label>
	...
	<script>
			...
			jQuery("#change_password").submit(function(e){
					...
					start_load();
						...
						var new_password = jQuery('#passwordo').val();
						var retype_password = jQuery('#passwords').val();
						...
						$.ajax({
							...
							success: function(resp){
                                ...
                                swal({
                                    type: "success",
                                    title: "Mot de passe a été modifié avec succès",
                                    showConfirmButton: true,
                                    confirmButtonText: "Fermer"

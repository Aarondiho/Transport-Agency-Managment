        ...
        <div class="col-12">
          ...
          <h6 class="font-weight-bolder mb-0">Dépenses</h6>
            ...
            <div class="card-body px-0 pb-2">
              <div class=" p-0">
              <table id="example" class="table table-striped align-items-center text-center mb-0">
                  <thead>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                          <h6 class=" w-10 text-xs font-weight-bold mb-0"><?php echo $i ; ?></h6> <img src="../photos/<?php  if(!empty($row['bill'])){echo $row['bill'];}else{ echo 'bill.png';}; ?>" class="avatar avatar-xs me-3 border-radius-lg" alt="cost1">
                          </div>
